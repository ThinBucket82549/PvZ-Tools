...
const Gw1Embed = new Discord.MessageEmbed()
    ...
    .setFooter(`Version - ${version}`)
    .setThumbnail('https://cdn.discordapp.com/attachments/722937222772293722/726896998124617758/image.png')
    .setTimestamp();
...
const Gw2Embed = new Discord.MessageEmbed()
    ...
    .setThumbnail('https://cdn.discordapp.com/attachments/722937222772293722/726897473079083048/unknown.png')
    .setFooter(`Version - ${version}`)
    .setTimestamp();
